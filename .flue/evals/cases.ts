...
export function commandsFor(state: string): Command[] {
	...
	const events = machine.events as Record<
		string,
		{ description?: string; arg?: string | null; destructive?: boolean }
	>;
...
export const CASES: Case[] = [
	...
	{
		state: "triage",
		comment: "would you take a stab at reproducing this",
		expected: "repro",
		tag: "idiomatic",
	},
	{
		state: "triage",
		comment: "please build a settings toggle for this",
		expected: "implement",
		tag: "plain",
	},
	{
		state: "triage",
		comment: "let's add a way to customize the slug format",
		expected: "implement",
		tag: "idiomatic",
	},
	{
		state: "triage",
		comment: "what do you think about this one?",
		expected: "none",
		tag: "question",
	},
	{
		state: "triage",
		comment: "ping me when you have a moment to look",
		expected: "none",
		tag: "polite-no",
	},
	...
	{
		state: "blocked",
		comment: "yes, go with option A but namespace it as emdash-admin",
		expected: "implement",
		tag: "directive",
	},
	...
	{
		state: "blocked",
		comment: "do it, but use a LEFT JOIN instead of the subquery",
		expected: "implement",
		tag: "directive",
	},
	...
	{
		state: "blocked",
		comment: "yeah let's just go with that",
		expected: "implement",
		tag: "idiomatic",
	},
	...
	{
		state: "blocked",
		comment: "this is working as intended, close it",
		expected: "none",
		tag: "adjacent",
	},
	...
	{
		state: "blocked",
		comment: "I'll take this one over manually",
		expected: "none",
		tag: "adjacent",
	},
	{
		state: "blocked",
		comment: "what part of the codebase is this in?",
		expected: "none",
		tag: "question",
	},
	{
		state: "blocked",
		comment: "hmm not sure this is even a bug",
		expected: "none",
		tag: "adjacent",
	},
	...
	// Plain confirms
	{
		...
		comment: "just tested the preview, the bug is gone, thanks!",
		expected: "confirm",
		tag: "plain",
	},
	...
	{
		state: "awaiting_feedback",
		comment: "nope, still broken on my end, same error",
		expected: "reject",
		tag: "plain",
	},
	{
		state: "awaiting_feedback",
		comment: "no dice, same issue",
		expected: "reject",
		tag: "idiomatic",
	},
	{
		state: "awaiting_feedback",
		comment: "didn't help, the page still 500s",
		expected: "reject",
		tag: "idiomatic",
	},
	...
	{
		state: "awaiting_feedback",
		comment: "fixed the error but now I see a different one when I save",
		expected: "reject",
		tag: "mixed",
	},
	// Questions / off-topic
	{
		state: "awaiting_feedback",
		comment: "how do I install the preview?",
		expected: "none",
		tag: "question",
	},
	{
		state: "awaiting_feedback",
		comment: "when will this land in a release?",
		expected: "none",
		tag: "question",
	},
	...
	{
		state: "awaiting_feedback",
		comment: "can you take another approach, the current one breaks SSR",
		expected: "retry",
		tag: "directive",
	},
	...
	{
		state: "in_review",
		comment: "the test name is misleading, rename it and add a null check",
		expected: "revise",
		tag: "feedback",
	},
	{
		state: "in_review",
		comment: "nit: could you rename `foo` to `fooSlug` for consistency",
		expected: "revise",
		tag: "feedback",
	},
	{
		state: "in_review",
		comment: "please add a test for the empty-array case",
		expected: "revise",
		tag: "feedback",
	},
	{
		state: "in_review",
		comment: "this needs to handle the locale=null path",
		expected: "revise",
		tag: "feedback",
	},
	...
	{
		state: "failed",
		comment: "the gateway was overloaded, run it again",
		expected: "retry",
		tag: "idiomatic",
	},
	{
		state: "failed",
		comment: "implement it differently, use a LEFT JOIN this time",
		expected: "implement",
		tag: "directive",
	},
	{
		state: "failed",
		comment: "let's try the alternative approach you mentioned",
		expected: "implement",
		tag: "directive",
	},
